          ...
          <div className="popup">
               <div className="popup-inner">
                    ...
                    <div className="description">
                         <h3>Reported by : <span>{props.data.firstName + ' ' + props.data.lastName}</span></h3>
                         <br/>
                         <h3>Email: <span>{props.data.submittedBy}</span></h3>
                    </div>
                    <div className="description">
                    ...
                    <div className="description">
                         {claimedBy?<h3>{button === 'Found' ? button : button + 'ed'} by
                              : <span>{claimedBy}</span></h3>:''}
